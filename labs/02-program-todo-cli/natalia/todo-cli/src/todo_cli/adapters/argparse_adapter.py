...
class ArgparseTodoCliAdapter(TodoCliPort):
    def run(self, argv: list[str], db_path: Path ) -> RunResult:
        ...
        # poprawnie nalezaloby utworzyc dodatkowy obiekt ktorego odpowiedzialnoscia bedzie
        # dopilnowanie odpowniednich typow ktore maj byc przekazane do use-casow
        # jako hotfix zrobimy rzutowanie w 45 i 47 linijce
